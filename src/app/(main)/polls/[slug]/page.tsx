...
import {
  ...
  useKeyopollsPollsApiGeneralGetPoll,
      ...
      <div className="bg-background mx-auto mb-20 max-w-2xl">
        <div ref={pollContentRef}>
          ...
          <div className="px-4">
            ...
            {/* Description */}
            {poll.description && (
              <p className="text-text-secondary mb-4 text-sm">{poll.description}</p>
            )}
                          ...
                          <div className="flex gap-3 pb-2" style={{ width: 'max-content' }}>
                            {poll.text_responses.map((response, index) => {
                              ...
                              const normalizedSize =
                                (response.response_count - minCount) / countRange;
                              ...
                              const sizeIndex = Math.floor(
                                normalizedSize * (sizeClasses.length - 1)
                              );
              ...
              <div className="border-success/20 bg-success/10 mb-4 rounded-lg border p-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-success text-sm">
                    {poll.correct_answer_stats.correct_count} out of {poll.total_voters} got it
                    right ({poll.correct_answer_stats.correct_percentage}%)
                  </span>
                </div>
              </div>
            )}
